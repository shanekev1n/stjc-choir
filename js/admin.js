...
function resetMemberPassword(userId, name) {
  ...
  document.getElementById('confirmYes').style.background = 'var(--lime)';
  document.getElementById('confirmYes').style.color = 'var(--lime-on)';
...
function showAdminMsg(msg, ok) {
  ...
  el.style.background = ok ? 'rgba(46,252,93,0.13)' : 'rgba(255,107,107,0.13)';
  el.style.border     = ok ? '1px solid rgba(46,252,93,0.35)' : '1px solid rgba(255,107,107,0.35)';
